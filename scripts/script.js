function createHead() {
    ...
    var ogTags = [
        ...
        { property: 'og:image', content: '/img/favicon.png' },  // Replace with your image URL
...
function createFooter() {
    ...
    footer.className = 'text-bg-light d-flex justify-content-center flex-column p-3';
    ...
    contactLink.className = 'footer-mail text-decoration-none text-secondary';
    ...
    copyright.textContent = '© 2023 Apna-Notes. All rights reserved.';

    // Append everything to the footer
    footer.appendChild(containerFluid);
    footer.appendChild(quickLinksContainer);
